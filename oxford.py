...
url = "http://www.thestudentroom.co.uk/showthread.php?t=3823629"
related = []
...
#    print(posts[0].text_content())
    post_count = 0
    for post in posts:
        if "computer science" in post.text_content() or "compsci" in post.text_content() or "comp sci" in post.text_content() or "CS " in post.text_content() or " CS" in post.text_content() or "CS." in post.text_content() or "MAT" in post.text_content():
